  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center overflow-x-hidden">
      <form className="bg-white shadow-md text-2xl" onSubmit={handleSubmit}>
          <div className="text-3xl align-center flex font-bold justify-center">LOGIN</div>
        <div className="m-5">
      ...
      <div className="text-2xl mt-4">
        Don't have an account? <Link to={'/register'} className="text-red-500 hover:text-red-300">Register</Link>
      </div>
    </div>
  );
};
